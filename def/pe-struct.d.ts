...
declare namespace PEStruct {
	...
	export const dosSignature: number;
	export const ntSignature: number;
	...
	export const sizeOfOptHdr32: number;
	export const sizeOfOptHdr64: number;
	...
	export const ntOptHdr32Magic: number;
	export const ntOptHdr64Magic: number;
	export const numberOfDataDirectories: number;
	...
	export const mdSignature: number;
	...
	export const mdsNameTable: string;
	export const mdsNameStrings: string;
	export const mdsNameUS: string;
	export const mdsNameGuid: string;
	export const mdsNameBlob: string;
	...
	export const numberOfMdTables: number;
	...
	export function load(buf: ArrayBuffer): PeStruct;
	export function loadIL(pe: PeStruct, m: MdtMethodDefItem): ILMethod;
	...
	export class PeError {
		public readonly type: PeErrorType;
	...
	export function copyData(pe: PeStruct, data: FileData): ArrayBuffer
	export function is64Bit(pe: PeStruct): boolean;
	...
	export function hasIL(methodDef: MdtMethodDefItem): boolean;
